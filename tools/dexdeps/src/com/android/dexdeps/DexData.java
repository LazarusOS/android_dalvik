...
public class DexData {
     ...
     */
    public void load(boolean includeMKClasses) throws IOException {
        parseHeaderItem();
        ...
        markInternalClasses(includeMKClasses);
    }
     ...
     */
    void markInternalClasses(boolean includeMKClasses) {
        ...
        for (int i = 0; i < mTypeIds.length; i++) {
            ...
            if (includeMKClasses && className.startsWith("Lmokee")) {
